...
Examining if the variables seem to be normally distributed by looking at the following plots. A box plot is also included to illustrate how much the values differ for the respective distance.    
